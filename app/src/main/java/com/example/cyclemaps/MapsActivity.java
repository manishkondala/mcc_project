...
import com.example.cyclemaps.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //Get User Location here, and zoom out the camera and show the cycle stands.


        // Add a marker in Sydney and move the camera

        //We have to get the locations of the cycle stands dynamically from cloud
